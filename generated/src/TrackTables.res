...
let trackAllTables = async () => {
  ...
  let _ = await trackTable(~tableName="Gauge")
  let _ = await createSelectPermissions(~tableName="Gauge")
  let _ = await trackTable(~tableName="LatestETHPrice")
  let _ = await createSelectPermissions(~tableName="LatestETHPrice")
  let _ = await trackTable(~tableName="LiquidityPool")
  let _ = await createSelectPermissions(~tableName="LiquidityPool")
  ...
  let _ = await trackTable(~tableName="LiquidityPoolUserMapping")
  let _ = await createSelectPermissions(~tableName="LiquidityPoolUserMapping")
  ...
  let _ = await trackTable(~tableName="StateStore")
  let _ = await createSelectPermissions(~tableName="StateStore")
  ...
  let _ = await createEntityRelationship(
    ...
    ~derivedFromFieldKey="",
    ~relationalKey="pool",
    ~mappedEntity="LiquidityPool",
  )
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPool",
    ~relationshipType="object",
    ~derivedFromFieldKey="",
  ...
  let _ = await createEntityRelationship(
    ...
    ~derivedFromFieldKey="liquidityPool",
    ~relationalKey="userMappings",
    ~mappedEntity="LiquidityPoolUserMapping",
  )
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPool",
    ~relationshipType="array",
    ~derivedFromFieldKey="pool",
    ~relationalKey="liquidityPoolHourlySnapshots",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="array",
    ~derivedFromFieldKey="pool",
    ~relationalKey="liquidityPoolDailySnapshots",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="array",
    ~derivedFromFieldKey="pool",
    ~relationalKey="liquidityPoolWeeklySnapshots",
    ~mappedEntity="LiquidityPoolWeeklySnapshot",
  )
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPoolDailySnapshot",
    ~relationshipType="object",
    ~derivedFromFieldKey="pool",
    ~relationalKey="gauge",
    ~mappedEntity="Gauge",
  ...
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPoolHourlySnapshot",
    ~relationshipType="object",
    ~derivedFromFieldKey="pool",
    ~relationalKey="gauge",
    ~mappedEntity="Gauge",
  ...
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPoolUserMapping",
    ~relationshipType="object",
    ~derivedFromFieldKey="",
    ~relationalKey="liquidityPool",
    ~mappedEntity="LiquidityPool",
  )
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPoolUserMapping",
  ...
  let _ = await createEntityRelationship(
    ~tableName="LiquidityPoolWeeklySnapshot",
    ~relationshipType="object",
    ~derivedFromFieldKey="pool",
    ~relationalKey="gauge",
    ~mappedEntity="Gauge",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="object",
    ~derivedFromFieldKey="",
    ~relationalKey="latestEthPrice",
    ~mappedEntity="LatestETHPrice",
  )
  let _ = await createEntityRelationship(
    ~tableName="Token",
    ~relationshipType="array",
    ~derivedFromFieldKey="token",
    ~relationalKey="tokenHourlySnapshots",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="array",
    ~derivedFromFieldKey="token",
    ~relationalKey="tokenDailySnapshots",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="array",
    ~derivedFromFieldKey="token",
    ~relationalKey="tokenWeeklySnapshots",
    ~mappedEntity="TokenWeeklySnapshot",
  )
  let _ = await createEntityRelationship(
    ~tableName="User",
    ~relationshipType="array",
    ~derivedFromFieldKey="user",
    ~relationalKey="liquidityPoolMappings",
    ~mappedEntity="LiquidityPoolUserMapping",
  )
}
