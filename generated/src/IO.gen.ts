...
import type {liquidityPoolNewEntity as Types_liquidityPoolNewEntity} from './Types.gen';
...
// tslint:disable-next-line:interface-over-type-literal
export type InMemoryStore_LiquidityPoolNew_value = Types_liquidityPoolNewEntity;

// tslint:disable-next-line:interface-over-type-literal
export type InMemoryStore_LiquidityPoolNew_key = string;

// tslint:disable-next-line:interface-over-type-literal
export type InMemoryStore_LiquidityPoolNew_t = InMemoryStore_storeState<InMemoryStore_LiquidityPoolNew_value,InMemoryStore_LiquidityPoolNew_key>;
...
export type InMemoryStore_t = {
  ...
  readonly liquidityPoolNew: InMemoryStore_LiquidityPoolNew_t; 
